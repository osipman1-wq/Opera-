        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-white rounded-3xl shadow-sm border border-neutral-100 p-8">
            ...
            <div className="space-y-6">
              ...
              {error && (
                <div className="mt-4 p-4 bg-neutral-50 text-neutral-500 rounded-2xl flex items-center gap-2 text-[10px] font-bold uppercase border border-neutral-100">
          ...
          <AnimatePresence mode="wait">
            {content ? (
              ...
              >
                ...
                <div className="p-12 flex-1 overflow-y-auto custom-scrollbar bg-[url('https://www.transparenttextures.com/patterns/notebook.png')]">
